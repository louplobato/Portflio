...
let hoverban = ref();
hoverban.value = false;
</script>

<template>
    <div class=" flex items-center justify-between  flex-row w-full static" aria-controls="ban" :aria-expanded="hoverban"
        ...
        <div class="motion-safe:transition-transform motion-safe:duration-800 w-full shesh flex justify-start">
            <svg viewBox="0 0 779 627" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="w-[100%] h-[35vw] shesh rotate-180">
                ...
                <circle cx="190" cy="437" r="25%" fill="black"
                    class="motion-safe:transition-transform motion-safe:duration-1000 liquid"
                    :class="['', hoverban ? 'translate-x-[-150px]' : '']" />
                <circle cx="504" cy="275" r="38%" fill="black"
                    class="motion-safe:transition-transform motion-safe:duration-1000 liquid"
                    :class="['', hoverban ? 'translate-x-[150px]' : '']" />
        </svg>
        ...
        <p
            class="text-[7vw] font-Chopper text-white mix-blend-difference z-20 absolute left-1/2 transform -translate-x-1/2 shadowtext ">
