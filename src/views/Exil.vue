        ...
        <div class="flex xl:flex-row-reverse flex-col items-center md:items-start justify-between gap-5">
            ...
            <div
                ...
                <h1 class="text-black sticky xl:text-7xl font-Chopper text-3xl">
                    Les Exilés des Quais
                </h1>
                <p class="text-black sticky font-Chopper xl:text-2xl w-1/2 text-center">
                    Solitude. Un spectre de sentiments en un seul mot. Mélancolie ? Tristesse ? Ou seulement se rapprocher
                    de soi même. Ces entités balances dans leurs ombres entre tout ces paramètres.
                </p>
            ...
            <div class="w-2/3 flex flex-col gap-5 max-h-full">
                <div>
                    <img src="../../Photos/Exilés1.jpg" alt="">
                </div>
                <div>
                    <img src="../../Photos/Exilés2.jpg" alt="">
                </div>
                <div>
                    <img src="../../Photos/Exilés3.jpg" alt="">
                </div>
            </div>
